...
export function initHomeAnimations(gsap, ScrollTrigger) {
            ...
            "(min-width: 769px)": function() {
                const scrollTween = gsap.to(scrollWrapper, {
                    ...
                    scrollTrigger: {
                        ...
                        anticipatePin: 1,
                        onUpdate: () => window.triggerHeaderShow && window.triggerHeaderShow()
                    }
                });
                ...
                ScrollTrigger.create({
                    ...
                    onEnter: () => {
                        ...
                        gsap.to("body", { backgroundColor: "#0A1128", color: "#FAF6EE", duration: 0.4 });
                        gsap.to(".showcase-header h2 span", { color: "#FAF6EE", duration: 0.4 });
                    },
                    onLeaveBack: () => {
                        document.body.classList.remove("dark-theme");
                        gsap.to("body", { backgroundColor: "var(--bg-canvas)", color: "#0A1128", duration: 0.4 });
                        gsap.to(".showcase-header h2 span", { color: "#0A1128", duration: 0.4 });
                    },
                    onLeave: () => {
                        document.body.classList.remove("dark-theme");
                        gsap.to("body", { backgroundColor: "var(--bg-canvas)", color: "#0A1128", duration: 0.4 });
    ...
    // Handled by ScrollTrigger.create on scrollContainer (Section 01)
    // ==========================================;
