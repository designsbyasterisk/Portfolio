...
export default function ResumeTemp() {
  return (
    <>
      ...
      {/* Navigation Header */}
      <header className="floating-header no-print">
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '50px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <span className="label-pill" style={{ fontSize: '0.65rem', padding: '4px 10px', margin: '0', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', height: '24px' }}>ABOUT ME (SANDBOX DRAFT)</span>
          </div>
          
          <nav style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-md)' }}>
            <Link to="/" className="font-display" style={{ fontSize: '0.9rem', margin: '0', display: 'inline-flex', alignItems: 'center' }}>PORTFOLIO</Link>
          </nav>
        </div>
      </header>
      ...
      <main className="container" style={{ paddingTop: '130px', maxWidth: '1200px' }}>
        ...
        <div className="resume-layout-grid">
          ...
          <div className="profile-photo-container no-print" style={{ position: 'relative' }}>
            ...
            <div className="bento-card" style={{ padding: '0', overflow: 'hidden', borderRadius: 'var(--bento-radius)', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
              <img src="/Me.jpg" alt="Shreya Kulkarni" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
          </div>

          {/* About & Contact (Bento Card) */}
          <div id="about" className="bento-card reveal" style={{ padding: 'var(--space-lg) 20px' }}>
            ...
            <ul className="contact-list">
              ...
              <li className="contact-item">
                ...
                <span>Woxsen University<br /><span className="contact-sub" style={{ fontSize: '0.8rem', color: 'var(--text-sub)' }}>(B.Des Hons. 2021 - 2025)</span></span>
              </li>
              <li className="contact-item">
              ...
              <li className="contact-item">
                ...
                <a href="mailto:designsbyasterisk@gmail.com" className="btn-ghost" style={{ fontWeight: '500', wordBreak: 'break-word' }}>designsbyasterisk@gmail.com</a>
              </li>
              <li className="contact-item">
                ...
                <a href="https://linkedin.com/in/shreyakulkarni01" target="_blank" rel="noreferrer" className="btn-ghost" style={{ fontWeight: '500', wordBreak: 'break-word' }}>shreyakulkarni01</a>
              </li>
            </ul>
          </div>

          {/* Skills & Software (Bento Card) */}
          <div id="skills" className="bento-card reveal" style={{ padding: 'var(--space-lg) 20px' }}>
          ...
          <div id="experience" className="bento-card reveal" style={{ padding: 'var(--space-lg)' }}>
          ...
          <div id="certificates" className="bento-card reveal" style={{ padding: 'var(--space-lg)' }}>
          ...
          <div className="no-print" id="portfolio-link-wrap">
            <Link to="/" className="bento-card reveal" id="portfolio-link" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', padding: 'var(--space-lg)', textDecoration: 'none', height: '100%' }}>
      ...
      {/* Footer */}
      <footer className="no-print" style={{ backgroundColor: 'var(--bg-card)', padding: 'var(--space-md) 0', marginTop: 'var(--space-xl)', borderTop: '1px solid rgba(10, 17, 40, 0.06)' }}>
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 'var(--space-md)' }}>
          <span className="mono" style={{ fontSize: '0.75rem', color: 'var(--text-main)' }}>© 2026 SHREYA KULKARNI. ALL RIGHTS RESERVED.</span>
          <Link to="/" className="mono" style={{ fontSize: '0.75rem', color: 'var(--text-main)' }}>BACK TO PORTFOLIO</Link>
        </div>
      </footer>
    </>
  );
