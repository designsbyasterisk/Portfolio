...
export default function F1DashboardTemp() {
  useEffect(() => {
      ...
      <header className="floating-header">
        <div className="container nav-wrapper" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '50px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <style dangerouslySetInnerHTML={{ __html: `
                  @keyframes kf_Frame_8_transform_0 {
                    0% {
                      ...
                      transform: translate(757px, 643.5px) rotate(6.283rad) translate(-757px, -643.5px);
                    }
                    100% {
                      transform: translate(757px, 643.5px) rotate(-6.283rad) translate(-757px, -643.5px);
                    }
            ...
            <span className="label-pill" style={{ fontSize: '0.65rem', padding: '4px 10px', margin: '0', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', height: '24px', backgroundColor: 'rgba(225, 6, 0, 0.06)', border: '1px solid rgba(225, 6, 0, 0.25)', color: '#e10600', borderRadius: '6px', fontWeight: '700' }}>F1 TELEMETRY</span>
          </div>
          
          <nav style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-md)' }}>
            <Link to="/resume" className="font-display" style={{ fontSize: '0.9rem', margin: '0', display: 'inline-flex', alignItems: 'center', color: 'var(--text-main)', textDecoration: 'none' }}>ABOUT ME</Link>
          </nav>
        </div>
      </header>
      ...
      <main className="narrative-wrapper">
              ...
              <div className="bento-card" style={{ margin: '0', backgroundColor: 'var(--brand-card-bg)', borderColor: 'var(--brand-border)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: 'var(--space-md) var(--space-lg)' }}>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: 'var(--space-md)' }}>
                    ...
                    <h3 style={{ fontFamily: "var(--font-display)", fontWeight: '700', color: 'var(--brand-text)', margin: '0', fontSize: '1.2rem' }}>Passive TV Broadcast</h3>
                  </div>
              ...
              <div className="bento-card" style={{ margin: '0', backgroundColor: 'var(--brand-card-bg)', borderColor: 'rgba(225, 6, 0, 0.15)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: 'var(--space-md) var(--space-lg)', boxShadow: '0 10px 30px rgba(225, 6, 0, 0.02)' }}>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: 'var(--space-md)' }}>
                    ...
                    <h3 style={{ fontFamily: "var(--font-display)", fontWeight: '700', color: 'var(--brand-text)', margin: '0', fontSize: '1.2rem' }}>Second-Screen Companion</h3>
                  </div>
            ...
            <div className="bento-card" style={{ margin: '0', padding: 'var(--space-md) var(--space-lg)', borderColor: 'var(--brand-border)', backgroundColor: 'var(--brand-card-bg)' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', borderBottom: '1px solid var(--brand-border)', paddingBottom: '12px', marginBottom: '16px', flexWrap: 'wrap', gap: '8px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '8px' }}>
                  ...
                  <span style={{ fontFamily: "var(--font-display)", fontWeight: '700', color: 'var(--brand-text)', fontSize: '0.95rem', marginTop: '4px' }}>Anatomy of Lap 18 Defense</span>
                </div>
        ...
        <section className="story-chapter" style={{ height: 'auto', padding: 'var(--space-xl) 0' }}>
          <div className="container" style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-lg)' }}>
            ...
            <div className="concept-layout-split" style={{ marginBottom: 'var(--space-md)' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', transform: 'translateY(-5px)' }}>
                ...
                <div className="bento-card" style={{ margin: '0', backgroundColor: 'var(--brand-card-bg)', borderColor: 'var(--brand-border)', borderTop: '3px solid var(--brand-accent)', padding: '22px 24px', borderRadius: '12px', boxShadow: '0 8px 24px rgba(0, 0, 0, 0.03)', transition: 'transform 0.25s ease, box-shadow 0.25s ease' }}>
                  ...
                  <h4 style={{ fontFamily: "var(--font-display)", fontWeight: '700', color: 'var(--brand-text)', margin: '0 0 8px 0', fontSize: '1.15rem', letterSpacing: '-0.01em' }}>Modular Grid Environment</h4>
                ...
                <div className="bento-card" style={{ margin: '0', backgroundColor: 'var(--brand-card-bg)', borderColor: 'var(--brand-border)', borderTop: '3px solid var(--brand-accent)', padding: '22px 24px', borderRadius: '12px', boxShadow: '0 8px 24px rgba(0, 0, 0, 0.03)', transition: 'transform 0.25s ease, box-shadow 0.25s ease' }}>
                  ...
                  <h4 style={{ fontFamily: "var(--font-display)", fontWeight: '700', color: 'var(--brand-text)', margin: '0 0 8px 0', fontSize: '1.15rem', letterSpacing: '-0.01em' }}>Strict Boundary Solver</h4>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
                <h4 style={{ fontFamily: "var(--font-display)", fontSize: '1rem', fontWeight: '700', color: 'var(--brand-text)', margin: '0 0 12px 0', textAlign: 'center' }}>Interactive Dynamic Grid Wireframe</h4>
            ...
            <div style={{ marginTop: 'var(--space-xl)', paddingTop: 'var(--space-lg)', borderTop: '1px solid var(--brand-border)', width: '100%' }}>
              ...
              <h3 style={{ fontFamily: "var(--font-display)", color: 'var(--brand-text)', margin: '0 0 12px 0', fontSize: '1.3rem', fontWeight: '700' }}>Data Pipeline &amp; Live Synchronization</h3>
              ...
              <div className="pipeline-flowchart">
                <div className="flow-step">
                  <span className="mono" style={{ fontSize: '0.65rem', color: 'var(--brand-accent)', display: 'block', marginBottom: '4px', fontWeight: '700' }}>STEP 01</span>
                  <h5 style={{ margin: '0 0 4px 0', color: 'var(--brand-text)', fontSize: '0.85rem', fontFamily: 'var(--font-display)', fontWeight: '500' }}>Raw F1 API</h5>
                  <p style={{ margin: '0', fontSize: '0.75rem', color: 'var(--brand-text-sub)', lineHeight: '1.4' }}>Jolpica/Ergast API timing and results metadata.</p>
                </div>
                
                <div className="flow-arrow">→</div>

                <div className="flow-step">
                  <span className="mono" style={{ fontSize: '0.65rem', color: 'var(--brand-accent)', display: 'block', marginBottom: '4px', fontWeight: '700' }}>STEP 02</span>
                  <h5 style={{ margin: '0 0 4px 0', color: 'var(--brand-text)', fontSize: '0.85rem', fontFamily: 'var(--font-display)', fontWeight: '500' }}>Timeline Cleaning</h5>
                  <p style={{ margin: '0', fontSize: '0.75rem', color: 'var(--brand-text-sub)', lineHeight: '1.4' }}>Removes Lap 1 outliers and adds grid stagger offsets.</p>
                </div>

                <div className="flow-arrow">→</div>

                <div className="flow-step">
                  <span className="mono" style={{ fontSize: '0.65rem', color: 'var(--brand-accent)', display: 'block', marginBottom: '4px', fontWeight: '700' }}>STEP 03</span>
                  <h5 style={{ margin: '0 0 4px 0', color: 'var(--brand-text)', fontSize: '0.85rem', fontFamily: 'var(--font-display)', fontWeight: '500' }}>Frame Synthesis</h5>
                  <p style={{ margin: '0', fontSize: '0.75rem', color: 'var(--brand-text-sub)', lineHeight: '1.4' }}>Generates 2 FPS telemetry (speed, brake, throttle).</p>
                </div>

                <div className="flow-arrow">→</div>

                <div className="flow-step">
                  <span className="mono" style={{ fontSize: '0.65rem', color: 'var(--brand-accent)', display: 'block', marginBottom: '4px', fontWeight: '700' }}>STEP 04</span>
                  <h5 style={{ margin: '0 0 4px 0', color: 'var(--brand-text)', fontSize: '0.85rem', fontFamily: 'var(--font-display)', fontWeight: '500' }}>Zustand Sync</h5>
                  <p style={{ margin: '0', fontSize: '0.75rem', color: 'var(--brand-text-sub)', lineHeight: '1.4' }}>Pipes unified frame state to active React widgets.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="deck-card gallery-slide-card" style={{ backgroundColor: 'var(--brand-card-bg)' }}>
                <div className="f1-deck-card-content">
                  ...
                  <div className="f1-deck-card-text">
                    ...
                    <h3 style={{ fontFamily: "var(--font-display)", color: 'var(--brand-text)', margin: '0 0 var(--space-xs) 0', fontSize: '1.4rem', fontWeight: '700' }}>3D Monaco Viewport</h3>
              ...
              <div className="deck-card gallery-slide-card" style={{ backgroundColor: 'var(--brand-card-bg)' }}>
                <div className="f1-deck-card-content">
                  ...
                  <div className="f1-deck-card-text">
                    ...
                    <h3 style={{ fontFamily: "var(--font-display)", color: 'var(--brand-text)', margin: '0 0 var(--space-xs) 0', fontSize: '1.4rem', fontWeight: '700' }}>Cockpit Gauges</h3>
                    <p style={{ fontSize: '0.85rem', lineHeight: '1.5', color: 'var(--text-sub)', margin: '0' }}>
              ...
              <div className="deck-card gallery-slide-card" style={{ backgroundColor: 'var(--brand-card-bg)' }}>
                <div className="f1-deck-card-content">
                  ...
                  <div className="f1-deck-card-text">
                    ...
                    <h3 style={{ fontFamily: "var(--font-display)", color: 'var(--brand-text)', margin: '0 0 var(--space-xs) 0', fontSize: '1.4rem', fontWeight: '700' }}>Driver Battles</h3>
                    <p style={{ fontSize: '0.85rem', lineHeight: '1.5', color: 'var(--text-sub)', margin: '0' }}>
              ...
              <div className="deck-card gallery-slide-card" style={{ backgroundColor: 'var(--brand-card-bg)' }}>
                <div className="f1-deck-card-content">
                    ...
                    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', gap: '8px', boxSizing: 'border-box' }}>
                      ...
                      <div style={{ flex: '1.2', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px' }}>
                        <div style={{ border: '1px solid rgba(255,255,255,0.08)', borderRadius: '8px', background: '#e10600', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '4px 0' }}>
                          <span style={{ fontFamily: "var(--font-display)", fontSize: '0.8rem', fontWeight: '700', color: '#ffffff', letterSpacing: '0.02em' }}>Red</span>
                        ...
                        <div style={{ border: '1px solid rgba(255,255,255,0.08)', borderRadius: '8px', background: '#030303', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '4px 0' }}>
                          <span style={{ fontFamily: "var(--font-display)", fontSize: '0.8rem', fontWeight: '700', color: '#ffffff', letterSpacing: '0.02em' }}>Black</span>
                        ...
                        <div style={{ border: '1px solid rgba(255,255,255,0.08)', borderRadius: '8px', background: 'rgba(255,255,255,0.9)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '4px 0' }}>
                          <span style={{ fontFamily: "var(--font-display)", fontSize: '0.8rem', fontWeight: '700', color: '#09090b', letterSpacing: '0.02em' }}>White</span>
                      ...
                      <div style={{ flex: '2', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
                        <div style={{ border: '1px solid rgba(255,255,255,0.08)', borderRadius: '8px', background: 'rgba(255,255,255,0.02)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '8px 6px', gap: '6px' }}>
                          <span style={{ fontFamily: "var(--font-display)", fontSize: '0.8rem', fontWeight: '700', color: '#ffffff', letterSpacing: '0.02em' }}>Team Graphics</span>
                        ...
                        <div style={{ border: '1px solid rgba(255,255,255,0.08)', borderRadius: '8px', background: 'rgba(255,255,255,0.02)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '8px 6px', gap: '8px' }}>
                          <span style={{ fontFamily: "var(--font-display)", fontSize: '0.8rem', fontWeight: '700', color: '#ffffff', letterSpacing: '0.02em' }}>Icons</span>
                  ...
                  <div className="f1-deck-card-text">
                    ...
                    <h3 style={{ fontFamily: "var(--font-display)", color: 'var(--brand-text)', margin: '0 0 var(--space-xs) 0', fontSize: '1.4rem', fontWeight: '700' }}>Graphics &amp; Styling</h3>
                    <p style={{ fontSize: '0.85rem', lineHeight: '1.5', color: 'var(--text-sub)', margin: '0' }}>
      ...
      <footer className="no-print project-site-footer">
        <div className="container has-projects-nav">
          <div className="footer-left">
            <Link to="/project-details/restease" className="font-display footer-link-prev">← RESTEASE</Link>
          </div>
          <div className="footer-center">
            <span className="mono footer-copyright">© 2026 SHREYA KULKARNI. ALL RIGHTS RESERVED.</span>
          </div>
          <div className="footer-right">
            <Link to="/project-details/honee" className="font-display footer-link-next">HONÉE →</Link>
          </div>
        </div>
      </footer>
    </>
