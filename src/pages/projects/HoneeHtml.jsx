        ...
        <section className="story-chapter chapter-hero">
          ...
          <div className="container hero-content">
            <div className="hero-text-block">
              <span className="label-pill brand-accent-badge" style={{ backgroundColor: 'rgba(217, 159, 13, 0.1)', color: '#d99f0d', border: '1px solid rgba(217, 159, 13, 0.2)' }}>PROJECT 04 //</span>
