...
export default function EmberquitHtml() {
  // Theme lifecycle
  useEffect(() => {
  ...
  const isBreathingActive = isBreathing;
  const breathingText = breathText;
...
<section className="story-chapter" style={{ padding: 'var(--space-xl) 0', height: 'auto', overflow: 'visible', display: 'block' }}>
            ...
            <div className="design-system-container">
              <div className="ds-grid">
                ...
                <div className="ds-column">
                  ...
                  {/* Card 11: Button States (Moved under Typography) */}
                  <div className="ds-card">
                    ...
                    <div className="ds-buttons-layout">
                      <div className="ds-btn-state-grid">
                        ...
                        <div><button className="ds-btn-state ds-btn-primary normal-static">i smoked</button></div>
                        <div><button className="ds-btn-state ds-btn-primary hover">i smoked</button></div>
                        <div><button className="ds-btn-state ds-btn-primary active">i smoked</button></div>

                        <div><button className="ds-btn-state ds-btn-outline normal-static">I beat it</button></div>
                        <div><button className="ds-btn-state ds-btn-outline hover">I beat it</button></div>
                        <div><button className="ds-btn-state ds-btn-outline active">I beat it</button></div>
                      </div>
                    </div>
                  </div>

                  {/* Card 2: Craving Triggers (App Dialog) */}
                  <div className="ds-card">
                    <div className="ds-section-title">Craving Triggers (App Dialog)</div>
                ...
                <div className="ds-column">
                  ...
                  {/* Card: Colors, Swatches & Patterns (Merged Card) */}
                  <div className="ds-card">
                    <div className="ds-section-title">Colors &amp; Patterns</div>
                    <div className="ds-color-swatch-list" style={{ marginBottom: '20px' }}>
                      {[
                    ...
                    <div className="ds-specimen-label" style={{ marginBottom: '12px', paddingTop: '16px', borderTop: '1px dashed rgba(10, 17, 40, 0.08)' }}>BLUEPRINT &amp; GRADIENT PATTERNS</div>
                    <div className="ds-pattern-row" style={{ display: 'flex', gap: '16px' }}>
                      <div className="ds-pattern-box blueprint" style={{ flex: 1, height: '80px', borderRadius: '12px', border: '1px solid rgba(0,25,230,0.15)', backgroundColor: '#FCFAF6', backgroundImage: 'radial-gradient(rgba(0, 25, 230, 0.15) 1px, transparent 0)', backgroundSize: '10px 10px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <span style={{ fontSize: '10px', fontWeight: '600', color: '#0019e6', letterSpacing: '0.05em', fontFamily: 'monospace' }}>BLUEPRINT</span>
                      </div>
                      <div className="ds-pattern-box gradient" style={{ flex: 1, height: '80px', borderRadius: '12px', background: 'linear-gradient(135deg, #0019e6, #3399ff)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 15px rgba(0,25,230,0.2)' }}>
                        <span style={{ fontSize: '10px', fontWeight: '600', color: '#ffffff', letterSpacing: '0.05em', fontFamily: 'monospace' }}>GRADIENT</span>
                      </div>
                    </div>
                  </div>

                  {/* Card 7: Today's Counter & Steppers Progress (Combined Card) */}
                  <div className="ds-card">
                    <div>
                      <div className="ds-section-title">Today's Counter</div>
                      <div className="ds-specimen-label" style={{ marginBottom: '12px' }}>ACTIVE CONSUMPTION COUNTER DIAL</div>
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '10px 0 20px 0', borderBottom: '1px dashed rgba(10, 17, 40, 0.08)', marginBottom: '20px' }}>
                        <div style={{ position: 'relative', width: '140px', height: '140px' }}>
                          ...
                          <div style={{ position: 'absolute', top: '0', left: '0', right: '0', bottom: '0', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: "'Inter', sans-serif" }}>
                            <span style={{ fontSize: '38px', fontWeight: '700', color: '#0a1128', lineHeight: '1' }}>5</span>
                            <span style={{ fontSize: '11px', fontWeight: '600', color: '#64748b', marginTop: '4px', letterSpacing: '0.02em' }}>of 6 today</span>
                          </div>
                        </div>
                        <p style={{ fontSize: '12px', fontWeight: '600', color: '#475569', margin: '14px 0 0 0', fontFamily: "'Inter', sans-serif", textAlign: 'center' }}>
                          1 left in your envelope today.
                        </p>
                      </div>
                    </div>

                    <div className="ds-progress-links-group" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                      ...
                      <div className="ds-progress-item">
                        ...
                        <div className="ds-line-progress-bar" style={{ marginTop: '6px' }}>
                  ...
                  <div className="ds-card">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left', marginBottom: '12px' }}>
                      <span style={{ fontSize: '11px', fontWeight: '700', color: '#475569', letterSpacing: '0.05em', fontFamily: "'Inter', sans-serif" }}>DAILY TREND</span>
                      <span style={{ fontSize: '13px', color: '#64748b', fontWeight: '500', fontFamily: "'Inter', sans-serif", marginTop: '2px' }}>Your line vs. your daily cap.</span>
                    </div>
                ...
                <div className="ds-column">
                  ...
                  {/* Card 3: Interactive Element (Box Breathing) (Moved to Column 3) */}
                  <div className="ds-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                    <div>
                      <div className="ds-section-title">Interactive Element</div>
                      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', textAlign: 'left', marginBottom: '16px' }}>
                        <div style={{ padding: '8px', background: 'rgba(0, 25, 230, 0.08)', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                        ...
                        <div>
                          ...
                          <p style={{ fontSize: '12px', color: '#475569', margin: 0, lineHeight: '1.4' }}>In 4 · hold 4 · out 4 · hold 4. Calms the nervous system in under a minute.</p>
                        </div>
                      </div>
                    </div>
                    
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', gap: '8px', margin: '4px 0' }}>
                      <div className={`ds-breathing-module ${isBreathingActive ? 'active' : ''}`} style={{ width: '100%', minHeight: '120px' }}>
                        <div className="ds-breathing-bg-glow"></div>
                        <div className="ds-breathing-circle-outer" style={{ width: '110px', height: '110px' }}>
                          <div className="ds-breathing-squircle-inner" style={{ width: '76px', height: '76px', borderRadius: '20px', fontSize: '12px' }}>{breathingText}</div>
                        </div>
                      </div>
                      <p className="ds-breathing-hint" style={{ margin: 0, fontSize: '11px', color: '#64748b', fontWeight: 600 }}>Match your breath to the glow.</p>
                    </div>

                    <button className={`ds-breathing-toggle-btn ${isBreathingActive ? 'active' : ''}`} onClick={toggleBreathing} style={{ marginTop: '8px', width: '100%' }}>
                      {isBreathingActive ? 'Stop Breathing' : 'Start Box Breathing'}
                    </button>
                  </div>

                  {/* Card 9: Monthly Heatmap */}
                  <div className="ds-card">
                    <div>
      ...
      <Footer prevProject={{ label: 'HONÉE', to: '/project-details/honee' }} nextProject={{ label: 'RESTEASE', to: '/project-details/restease' }} />
    </>
  );
}
